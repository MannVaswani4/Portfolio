...
export default function EducationAndCertifications() {
  return (
    <section id="education" className="pt-4 pb-12 bg-background text-on-surface">
      <div className="container mx-auto px-6 max-w-[1440px] space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto w-full">
          ...
          <motion.div
            ...
            className="h-full"
          >
            <Card className="p-8 sm:p-10 min-h-[220px] sm:min-h-[240px] flex flex-col sm:flex-row gap-6 items-start h-full bg-surface-lowest/70 backdrop-blur-md border border-outline-variant/20 hover:border-primary-container/40 transition-colors">
              <div className="w-20 h-20 shrink-0 flex items-center justify-center bg-white p-2 rounded-xl border border-outline-variant/10">
              ...
              <div className="space-y-3 flex-grow">
                ...
                <p className="font-sans text-base sm:text-lg font-semibold text-secondary">
                  B.Tech - Computer Science and Artificial Intelligence
                </p>
                <div className="flex flex-wrap gap-x-4 gap-y-2 font-mono text-xs sm:text-sm text-on-surface-variant/80">
